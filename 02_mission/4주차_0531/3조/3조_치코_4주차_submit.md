...
![526](attachments/Pasted%20image%2020260531195504.png)
...
- **언제 도나**: 매일 오전 11시.
![267](attachments/Pasted%20image%2020260531201136.png)
...
- 단 2명, 찐 고객 페르소나에게 피드백 받은 내용
	- 옵시디엔에 있는 나의 워크로그들을 기반으로 여러 에이전트들 (캐러셀 os 제외, 포폴메이커 제외)에 대 해 단 2명, 찐 고객 페르소나 관점에서 피드백을 해줘봐.
		- 에이전트가 내뱉는 에디터의 최종 결과물을 읽는 사람
		- 이 프로젝트를 이미 해본 사람으로서 PM을 역량을 가진 사람
