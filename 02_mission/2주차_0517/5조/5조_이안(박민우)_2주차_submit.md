...
첫 AI 영상 1편을 **13.2초 · $0.5** 로 완주. 원래는 캡컷·파이널컷에서 후편집할 줄 알았는데, 픽커·자막 싱크 HTML 도구 두 개로 NLE 없이 끝남.

옛날엔 *"바퀴를 재발명하지 말라"* 가 정답인 시대였지만, AI로 30분이면 내 워크플로우 전용 도구가 나오는 시대엔 **"기존 도구 학습 비용 vs 맞춤 도구 제작 비용"** 의 균형점이 옮겨간 듯. 캡컷 배우는 시간에 픽커·싱크 HTML을 짜는 게 본인 워크플로우엔 더 빨랐음.

### 최종 구현 결과물

- Instagram: https://www.instagram.com/p/DYb4HyTD5HL/
