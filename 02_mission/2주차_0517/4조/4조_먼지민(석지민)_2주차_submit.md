...
- **vault 새 부품**: `100_rules/PERSONA.md` v0.1 (이번 주 신규 산출물)
- **본 작업 worktree**: `quizzical-panini-8edecb` (SC W2 미션 작업판)
- **컨트롤타워 worktree**: `sweet-wescoff-9481cb` (자료 추출·핸드오프 담당)
- **관련 결정 로그**: d009 (텔레그램 채널 셋업) / d011 (데스크탑 듀얼 봇) / d012 (자동 발행 충돌 진단)
