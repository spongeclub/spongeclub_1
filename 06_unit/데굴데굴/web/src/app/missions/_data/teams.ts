import type { Member, MemberStatus, Team } from "../_lib/types";
 ...
 * - submittedWeeks: 제출 완료한 원본 주차
 * - writingWeek: 현재 작성 중인 주차 (있으면 1)
 *
 * 원본 0주차(셋업)는 화면에서 1주차로 표시.
...
export const teams: Team[] = [
  {
    ...
    members: [
      ...
      { nickname: "임솔", role: "crew", submittedWeeks: [0] },
  ...
  },
  {
    ...
    members: [
      ...
      { nickname: "Iny", role: "crew", submittedWeeks: [0], writingWeek: 1 },
      ...
      { nickname: "에이미", role: "crew", submittedWeeks: [0] },
    ],
  },
  {
    number: 3,
    ...
    members: [
      ...
      { nickname: "뿌까", role: "crew", submittedWeeks: [0] },
    ],
  },
  {
    number: 4,
    ...
    members: [
      ...
      { nickname: "린", role: "crew", submittedWeeks: [0], writingWeek: 1 },
      { nickname: "거위의꿈", role: "crew", submittedWeeks: [0] },
      { nickname: "설민주", role: "crew", submittedWeeks: [0] },
      { nickname: "나로", role: "crew", submittedWeeks: [0] },
      { nickname: "리보", role: "crew", submittedWeeks: [0] },
      { nickname: "정정민", role: "crew", submittedWeeks: [0] },
    ],
  },
  {
    number: 5,
    ...
    members: [
      ...
      { nickname: "Keno", role: "vice", submittedWeeks: [0, 1] },
      { nickname: "써니", role: "crew", submittedWeeks: [0, 1] },
      ...
      { nickname: "헤이즐", role: "crew", submittedWeeks: [0] },
      { nickname: "애니", role: "crew", submittedWeeks: [0] },
  ...
  },
  {
    ...
    members: [
      ...
      { nickname: "Hook2", role: "crew", submittedWeeks: [0, 1] },
      { nickname: "하늘", role: "crew", submittedWeeks: [0, 1] },
      { nickname: "Galia", role: "crew", submittedWeeks: [0], writingWeek: 1 },
      { nickname: "허니바른", role: "crew", submittedWeeks: [0], writingWeek: 1 },
      { nickname: "아이리스", role: "crew", submittedWeeks: [0] },
...
export function memberStatus(member: Member, week: number): MemberStatus {
  const sourceWeek = Math.max(0, week - 1);
  if (member.submittedWeeks?.includes(sourceWeek)) return "submitted";
  if (member.writingWeek === sourceWeek) return "writing";
  return "todo";
}
